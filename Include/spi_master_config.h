...
// SPI0. 
#define SPI_PSELSCK0            14u                                     /**< SPI clock GPIO pin number. */
#define SPI_PSELMOSI0           13u                                     /**< SPI Master Out Slave In GPIO pin number. */
#define SPI_PSELMISO0           12u                                     /**< SPI Master In Slave Out GPIO pin number. */
#define SPI_PSELSS0             10u      					                     	/**< SPI Slave Select GPIO pin number. */

// SPI1.
#define SPI_PSELSCK1            14u                                     /**< SPI clock GPIO pin number. */
#define SPI_PSELMOSI1           13u                                     /**< SPI Master Out Slave In GPIO pin number. */
#define SPI_PSELMISO1           12u                                     /**< SPI Master In Slave Out GPIO pin number. */
#define SPI_PSELSS1             10u                                     /**< SPI Slave Select GPIO pin number. */
